...
const botonesCategorias = document.querySelectorAll(".button__categorias");
const titlePrincipal = document.querySelector("#titulo-principal");
  ...
  productosElegidos.forEach((producto) => {
    ...
    div.innerHTML = `
      ...
      <div class="producto__detalles">
        <h3 class="producto__title">${producto.titulo}</h3>
...
botonesCategorias.forEach((boton) => {
  boton.addEventListener("click", (e) => {
    ...
    if (e.currentTarget.id != "todos") {
      ...
      titlePrincipal.innerText = productoCategoria.categoria.nombre;
